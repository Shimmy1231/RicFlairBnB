...
![image](https://user-images.githubusercontent.com/111400731/232669291-9dbaf1a9-ab1e-4ab3-85af-213ffb1060d3.png)
...
* Request
  * Method: POST
  * URL: '/users/:userId/reviews/:reviewId/images/new'
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: '/users/:userId/reviews/:id/images/:imageId'
  * Body: none
